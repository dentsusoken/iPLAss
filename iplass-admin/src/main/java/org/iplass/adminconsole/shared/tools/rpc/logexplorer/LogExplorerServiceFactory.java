...
public abstract class LogExplorerServiceFactory extends AbstractAdminServiceFactory {

	private static LogExplorerServiceAsync service;

	private LogExplorerServiceFactory() {
	}

	public static LogExplorerServiceAsync get() {
		if (service != null) {
			return service;
		}

...
public interface NameListDownloadProperty extends DownloadProperty {

	public static final String ACTION_URL = "service/metanamelistdownload";
	...
	//for Repository
	//----------------------
	public static final String TARGET_PATH = "paths";

...
public abstract class EntityExplorerServiceFactory extends AbstractAdminServiceFactory {

	private static EntityExplorerServiceAsync service;

	private EntityExplorerServiceFactory() {
	}

	public static EntityExplorerServiceAsync get() {
		if (service != null) {
			return service;
		}

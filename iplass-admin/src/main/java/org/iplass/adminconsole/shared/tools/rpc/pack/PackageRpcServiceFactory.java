...
public abstract class PackageRpcServiceFactory extends AbstractAdminServiceFactory {

	private static PackageRpcServiceAsync service;

	private PackageRpcServiceFactory() {
	}

	public static PackageRpcServiceAsync get() {
		if (service != null) {
			return service;
		}

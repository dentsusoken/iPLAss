...
public class EntityCsvFatalException extends RuntimeException {
	...
	public EntityCsvFatalException(String message, Throwable cause) {
		super(message, cause);
	}

	public EntityCsvFatalException(String message) {
		super(message);
	}

	public EntityCsvFatalException(Throwable cause) {
		super(cause);
	}

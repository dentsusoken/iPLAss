...
public class RestrictionRequestAttributePane extends VLayout {
	...
	public RestrictionRequestAttributePane() {
		...
		txaAllowRequestContentTypes.setTitle(AdminClientMessageUtil.getString("ui_metadata_action_RestrictionRequestAttributePane_allowRequestContentTypesField"));
		...
		txtMaxRequestBodySize.setTitle(AdminClientMessageUtil.getString("ui_metadata_action_RestrictionRequestAttributePane_maxRequestBodySizeField"));
		...
		txtMaxFileSize.setTitle(AdminClientMessageUtil.getString("ui_metadata_action_RestrictionRequestAttributePane_maxFileSizeField"));

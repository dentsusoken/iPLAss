...
public interface PropertyAttribute {
	...
	void applyFrom(PropertyDefinition property, EntityDefinition entity);

	void applyTo(PropertyDefinition property, EntityDefinition entity);

	void applyTo(PropertyListGridRecord record);

	public static class DefaultAttribute implements PropertyAttribute {

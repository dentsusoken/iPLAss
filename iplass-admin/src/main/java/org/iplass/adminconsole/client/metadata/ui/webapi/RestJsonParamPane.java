...
/**
 * REST JSON パラメータ設定パネル
 *
 * <p>
 * REST JSON のチェックボックスを設定すると表示されるパネルです。
 * </p>
 */
public class RestJsonParamPane extends HLayout {
	 ...
	 * コンストラクタ
	 */
	public RestJsonParamPane() {

		Label caption = new Label("REST JSON Parameter :");
		...
		acceptableContentTypes.setTooltip(
				SmartGWTUtil.getHoverString(AdminClientMessageUtil.getString("ui_metadata_webapi_RestJsonParamPane_acceptableContentTypes_tooltip")));

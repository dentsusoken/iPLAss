...
public class WebApiParamMapEditDialog extends MtpDialog {
	...
	public WebApiParamMapEditDialog() {
		...
		editScript.addClickHandler(new com.smartgwt.client.widgets.form.fields.events.ClickHandler() {
			...
			public void onClick(com.smartgwt.client.widgets.form.fields.events.ClickEvent event) {
				MetaDataUtil.showScriptEditDialog(ScriptEditorDialogMode.GROOVY_SCRIPT,
						...
						ScriptEditorDialogConstants.WEBAPI_PARAMMAP_CONDITION,
						"ui_metadata_webapi_WebAPIParamMapEditDialog_conditionHint",
						null,
	...
	/**
	 * 編集対象の {@link WebApiParamMapDefinition} を設定します。
	 * @param paramMap 編集対象の {@link WebApiParamMapDefinition}
	 */
	...
	private void getEditedParamMap() {
		WebApiParamMapDefinition paramMap = new WebApiParamMapDefinition();
	 ...
	 * データ変更通知処理
	 */
	private void fireDataChanged(WebApiParamMapDefinition paramMap) {

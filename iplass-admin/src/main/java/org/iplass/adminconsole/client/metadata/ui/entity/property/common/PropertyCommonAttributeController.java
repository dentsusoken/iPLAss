...
public interface PropertyCommonAttributeController {

	List<PropertyCommonAttributeParts> partsList();

	HasNotNullHandler notNullParts();

	CommonAttribute createCommonAttribute();

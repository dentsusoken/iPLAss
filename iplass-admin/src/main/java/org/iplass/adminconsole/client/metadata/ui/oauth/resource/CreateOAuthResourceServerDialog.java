...
public class CreateOAuthResourceServerDialog extends MetaDataCreateDialog {
	...
	public CreateOAuthResourceServerDialog(String definitionClassName, String nodeDisplayName, String folderPath, boolean isCopyMode) {
	...
	private void createDefinition(final SaveInfo saveInfo, final boolean isCopyMode) {
		...
		if (isCopyMode) {
			...
			OAuthResourceServerDefinition definition = new OAuthResourceServerDefinition();

...
/**
 * SelectValue新規作成ダイアログ
 */
public class CreateSelectValueDialog extends MetaDataCreateDialog {

	public CreateSelectValueDialog(String definitionClassName, String nodeDisplayName, String folderPath, boolean isCopyMode) {
	...
	private void createDefinition(final SaveInfo saveInfo, final boolean isCopyMode) {
		...
		if (isCopyMode) {
			...
			SelectValueDefinition definition = new SelectValueDefinition();

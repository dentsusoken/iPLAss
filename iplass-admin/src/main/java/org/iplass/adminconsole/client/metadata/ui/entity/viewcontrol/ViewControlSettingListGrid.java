...
public class ViewControlSettingListGrid extends ListGrid {
	...
	public ViewControlSettingListGrid() {
		...
		setHeaderSpans(detailHeader, searchHeader);
		setHeaderHeight(44);
...
//		permitRolesField.setWidth(250);
		...
		// 各フィールドをListGridに設定
		setFields(displayNameField, definedDvField, autogenerateDvField, definedSvField, autogenerateSvField, permitRolesField);

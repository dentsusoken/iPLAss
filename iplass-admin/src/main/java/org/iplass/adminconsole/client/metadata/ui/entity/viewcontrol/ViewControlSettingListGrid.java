...
public class ViewControlSettingListGrid extends ListGrid {
	...
	public ViewControlSettingListGrid() {
		...
		// 各フィールド初期化
		ListGridField displayNameField = new ListGridField(ViewControlSettingListGridRecord.DISPLAY_NAME, AdminClientMessageUtil.getString("ui_metadata_ui_entity_viewcontrol_ViewControlSettingListGrid_viewName"));
		displayNameField.setWidth(100);
		displayNameField.setCanEdit(false);

		ListGridField definedDvField = new ListGridField(ViewControlSettingListGridRecord.EXISTDVIEW, AdminClientMessageUtil.getString("ui_metadata_ui_entity_viewcontrol_ViewControlSettingListGrid_definedDv"));
		definedDvField.setWidth(100);
		definedDvField.setCanEdit(false);
		definedDvField.setType(ListGridFieldType.BOOLEAN);

		ListGridField autogenerateDvField = new ListGridField(ViewControlSettingListGridRecord.AGDVIEW, AdminClientMessageUtil.getString("ui_metadata_ui_entity_viewcontrol_ViewControlSettingListGrid_autogenerateDv"));
		autogenerateDvField.setWidth(100);
		autogenerateDvField.setType(ListGridFieldType.BOOLEAN);

		ListGridField definedSvField = new ListGridField(ViewControlSettingListGridRecord.EXISTSVIEW, AdminClientMessageUtil.getString("ui_metadata_ui_entity_viewcontrol_ViewControlSettingListGrid_definedSv"));
		definedSvField.setWidth(100);
		definedSvField.setCanEdit(false);
		definedSvField.setType(ListGridFieldType.BOOLEAN);

		ListGridField autogenerateSvField = new ListGridField(ViewControlSettingListGridRecord.AGSVIEW, AdminClientMessageUtil.getString("ui_metadata_ui_entity_viewcontrol_ViewControlSettingListGrid_autogenerateSv"));
		autogenerateSvField.setWidth(100);
		autogenerateSvField.setType(ListGridFieldType.BOOLEAN);

		ListGridField definedBvField = new ListGridField(ViewControlSettingListGridRecord.EXISTBVIEW, AdminClientMessageUtil.getString("ui_metadata_ui_entity_viewcontrol_ViewControlSettingListGrid_definedBv"));
		definedBvField.setWidth(100);
		definedBvField.setCanEdit(false);
		definedBvField.setType(ListGridFieldType.BOOLEAN);

		ListGridField autogenerateBvField = new ListGridField(ViewControlSettingListGridRecord.AGBVIEW, AdminClientMessageUtil.getString("ui_metadata_ui_entity_viewcontrol_ViewControlSettingListGrid_autogenerateBv"));
		autogenerateBvField.setWidth(100);
		autogenerateBvField.setType(ListGridFieldType.BOOLEAN);

		ListGridField permitRolesField = new ListGridField(ViewControlSettingListGridRecord.PERMIT_ROLES, AdminClientMessageUtil.getString("ui_metadata_ui_entity_viewcontrol_ViewControlSettingListGrid_permitRoles"));

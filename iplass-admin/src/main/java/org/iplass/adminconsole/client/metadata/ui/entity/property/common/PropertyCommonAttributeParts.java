...
public abstract class PropertyCommonAttributeParts extends VLayout implements PropertyAttributePane {

	public abstract void initialize(PropertyCommonAttributePane owner, PropertyCommonAttributePaneHandler handler);

	public interface TypeChangeHandler {
		void onTypeChanged(PropertyDefinitionType type);
	}

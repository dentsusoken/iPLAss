...
public class MetaDataTreeGridPane extends VLayout {
	...
	public MetaDataTreeGridPane(AdvancedSearchExecHandler handler) {
	...
	public class MetaDataAdvancedSearchPane extends VLayout {
		...
		public MetaDataAdvancedSearchPane() {
			...
			condForm.setIsGroup(true);
			condForm.setGroupTitle("Advanced Search");
...
//			updateDateFromField.setTitle("UpdateDate");
...
//			tagFromNameField.setCanEdit(false);
//			tagFromNameField.setCanFocus(false);
...
//			tagFromDateField.setCanEdit(false);
//			tagFromDateField.setCanFocus(false);
...
//			tagToNameField.setCanEdit(false);
//			tagToNameField.setCanFocus(false);
...
//			tagToDateField.setCanEdit(false);
//			tagToDateField.setCanFocus(false);
...
//			fetchData(new Criteria(MetaDataTreeDS.CRITERIA_TYPE, repositoryType.getValueAsString()));

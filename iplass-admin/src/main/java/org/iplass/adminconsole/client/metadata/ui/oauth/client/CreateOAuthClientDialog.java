...
/**
 * OAuthClientDefinition新規作成ダイアログ
 */
public class CreateOAuthClientDialog extends MetaDataCreateDialog {

	public CreateOAuthClientDialog(String definitionClassName, String nodeDisplayName, String folderPath, boolean isCopyMode) {
	...
	private void createDefinition(final SaveInfo saveInfo, final boolean isCopyMode) {
		...
		if (isCopyMode) {
			...
			OAuthClientDefinition definition = new OAuthClientDefinition();

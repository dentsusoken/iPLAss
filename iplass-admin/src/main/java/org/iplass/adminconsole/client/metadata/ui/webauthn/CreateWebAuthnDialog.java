 ...
 * WebAuthn新規作成ダイアログ
 */
public class CreateWebAuthnDialog extends MetaDataCreateDialog {

	public CreateWebAuthnDialog(String definitionClassName, String nodeDisplayName, String folderPath, boolean isCopyMode) {

...
public class ParamMapGridPane extends VLayout {
	...
	private ListGridRecord createRecord(ParamMapDefinition param, ListGridRecord record) {
		if (record == null) {
	...
	private void editMap(final ListGridRecord record) {
		final ParamMapEditDialog dialog = new ParamMapEditDialog();
		dialog.addDataChangeHandler(new DataChangedHandler() {

			@Override
			public void onDataChanged(DataChangedEvent event) {
				ParamMapDefinition param = event.getValueObject(ParamMapDefinition.class);

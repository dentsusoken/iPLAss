...
/**
 * AuthenticationPolicy新規作成ダイアログ
 */
public class CreateAuthenticationPolicyDialog extends MetaDataCreateDialog {

	public CreateAuthenticationPolicyDialog(String definitionClassName, String nodeDisplayName, String folderPath, boolean isCopyMode) {
	...
	private void createDefinition(final SaveInfo saveInfo, final boolean isCopyMode) {
		...
		if (isCopyMode) {
			...
			AuthenticationPolicyDefinition definition = new AuthenticationPolicyDefinition();

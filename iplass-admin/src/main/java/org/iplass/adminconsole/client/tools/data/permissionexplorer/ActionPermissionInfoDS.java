...
public class ActionPermissionInfoDS extends PermissionTreeGridDS {
	 ...
	 * @return DSインスタンス
	 */
	public static ActionPermissionInfoDS getInstance(LinkedHashMap<String, Entity> roleMap) {
		return new ActionPermissionInfoDS(roleMap);
	}

	private ActionPermissionInfoDS(LinkedHashMap<String, Entity> roleMap) {
		super(roleMap);
	}
	...
	protected void executeFetch(final String requestId, final DSRequest request, final DSResponse response) {
		...
		if (criteria != null && criteria.getAttributeAsObject(EDIT_DATA_KEY) != null) {
			...
			//ここが個別
			service.getAllActionPermissionData(TenantInfoHolder.getId(), new AsyncCallback<PermissionSearchResult>() {

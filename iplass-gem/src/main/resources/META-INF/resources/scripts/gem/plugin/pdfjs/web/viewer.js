...
/*
 * mtp modify
 *  configure(PDFJS) : Modified to PDFJS.workerSrc it is not overwritten.
 */
...
function configure(PDFJS) {
  PDFJS.imageResourcesPath = PDFJS.imageResourcesPath ? PDFJS.imageResourcesPath : './images/'; // mtp modify PDFJS.imageResourcesPath = './images/';
  PDFJS.workerSrc = PDFJS.workerSrc ? PDFJS.workerSrc : '../build/pdf.worker.js'; // mtp modify PDFJS.workerSrc = '../build/pdf.worker.js';
  PDFJS.cMapUrl = PDFJS.cMapUrl ? PDFJS.cMapUrl : '../web/cmaps/'; // mtp modify PDFJS.cMapUrl = '../web/cmaps/';

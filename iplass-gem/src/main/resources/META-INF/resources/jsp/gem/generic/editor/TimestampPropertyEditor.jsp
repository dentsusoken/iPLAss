...
<%@ page import="org.iplass.mtp.entity.definition.properties.DateTimeProperty"%>
...
<%
	...
	if (pd == null || !(pd instanceof DateTimeProperty)) {
		//定義がDateTimePropertyか、Expression(resultType=Datetime)でなければ表示不可
	...
	if (OutputType.EDIT == type || OutputType.BULK == type) {
		//詳細編集 or 一括更新編集
%>
<jsp:include page="./timestamp/TimestampPropertyEditor_Edit.jsp"></jsp:include>
...
<%
		...
		//詳細表示
%>
<jsp:include page="./timestamp/TimestampPropertyEditor_View.jsp"></jsp:include>
<%
	} else if (OutputType.SEARCHCONDITION == type) {
		//検索条件
%>
<jsp:include page="./timestamp/TimestampPropertyEditor_Condition.jsp"></jsp:include>
<%
	} else {
		//検索結果
%>

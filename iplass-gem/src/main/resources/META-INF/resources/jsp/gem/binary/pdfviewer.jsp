...
<html dir="ltr" mozdisallowselectionprint>
  <head>
    ...
    <link rel="stylesheet" href="${m:esc(staticContentPath)}/webjars/pdf-js/3.1.81//web/viewer.css">

<!-- This snippet is used in production (included from viewer.html) -->
<link rel="resource" type="application/l10n" href="${m:esc(staticContentPath)}/webjars/pdf-js/3.1.81//web/locale/locale.properties">
<script src="${m:esc(staticContentPath)}/webjars/pdf-js/3.1.81//build/pdf.js"></script>

  <script>
  window.pdfJsWorkerSrc = "${m:esc(staticContentPath)}/webjars/pdf-js/3.1.81//build/pdf.worker.js"
  </script>

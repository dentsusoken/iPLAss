...
<%@ page import="org.iplass.mtp.entity.definition.properties.BooleanProperty"%>
...
<%
	...
	if (pd == null || !(pd instanceof BooleanProperty)) {
		//定義がBooleanPropertyか、Expression(resultType=Boolean)でなければ表示不可
...
<%
		...
		//詳細表示
%>
<jsp:include page="./boolean/BooleanPropertyEditor_View.jsp"></jsp:include>
<%
	} else if (OutputType.SEARCHCONDITION == type) {
		//検索条件
%>
<jsp:include page="./boolean/BooleanPropertyEditor_Condition.jsp"></jsp:include>
<%
	} else {
		//検索結果
%>

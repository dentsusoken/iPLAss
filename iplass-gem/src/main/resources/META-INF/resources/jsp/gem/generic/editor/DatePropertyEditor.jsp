...
<%
	...
	if (OutputType.EDIT == type || OutputType.BULKEDIT == type) {
		//詳細編集 or 一括更新編集
%>
<jsp:include page="./date/DatePropertyEditor_Edit.jsp"></jsp:include>
...
<%
		...
		//詳細表示
%>
<jsp:include page="./date/DatePropertyEditor_View.jsp"></jsp:include>
<%
	} else if (OutputType.SEARCHCONDITION == type) {
		//検索条件
%>
<jsp:include page="./date/DatePropertyEditor_Condition.jsp"></jsp:include>
<%
	} else {
		//検索結果
%>

...
<%@ page import="org.iplass.mtp.entity.definition.properties.TimeProperty"%>
...
<%
	...
	if (pd == null || !(pd instanceof TimeProperty)) {
		//定義がTimePropertyか、Expression(resultType=Time)でなければ表示不可
...
<%
		...
		//詳細表示
%>
<jsp:include page="./time/TimePropertyEditor_View.jsp"></jsp:include>
<%
	} else if (OutputType.SEARCHCONDITION == type) {
		//検索条件
%>
<jsp:include page="./time/TimePropertyEditor_Condition.jsp"></jsp:include>
<%
	} else {
		//検索結果
%>

...
<%
		...
		//詳細表示
%>
<jsp:include page="./authpolicyselect/AuthenticationPolicySelectPropertyEditor_View.jsp"></jsp:include>
<%
	} else if (OutputType.SEARCHCONDITION == type) {
		//検索条件
%>
<jsp:include page="./authpolicyselect/AuthenticationPolicySelectPropertyEditor_Condition.jsp"></jsp:include>
<%
	} else {
		//検索結果
%>

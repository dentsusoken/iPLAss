...
%>
	...
	function search() {
		...
		searchEntityList("<%=SearchListCommand.WEBAPI_NAME%>", "${m:escJs(MetaEntityListParts_entityListParts.defName)}", "${m:escJs(MetaEntityListParts_entityListParts.viewName)}", "${m:escJs(MetaEntityListParts_entityListParts.filterName)}", offset, sortKey, sortType, "<%=searchAsync%>", function(count, list) {

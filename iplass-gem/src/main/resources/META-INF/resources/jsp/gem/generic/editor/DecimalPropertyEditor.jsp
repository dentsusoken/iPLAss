...
<%@ page import="org.iplass.mtp.entity.definition.properties.DecimalProperty"%>
...
<%
	...
	if (pd == null || !(pd instanceof DecimalProperty)) {
		//定義がDecimalPropertyか、Expression(resultType=Decimal)でなければ表示不可
	...
	if (OutputType.EDIT == type) {
		//詳細編集
%>
<jsp:include page="./decimal/DecimalPropertyEditor_Edit.jsp"></jsp:include>
...
<%
		...
		//詳細表示
%>
<jsp:include page="./decimal/DecimalPropertyEditor_View.jsp"></jsp:include>
<%
	} else if (OutputType.SEARCHCONDITION == type) {
		//検索条件
%>
<jsp:include page="./decimal/DecimalPropertyEditor_Condition.jsp"></jsp:include>
<%
	} else {
		//検索結果
%>

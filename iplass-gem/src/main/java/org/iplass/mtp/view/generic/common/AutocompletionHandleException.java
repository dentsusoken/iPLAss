...
public class AutocompletionHandleException extends ApplicationException {
	...
	public AutocompletionHandleException(String message, Throwable cause) {
		super(message, cause);
	}

	public AutocompletionHandleException(String message) {
		super(message);
	}

	public AutocompletionHandleException(Throwable cause) {
		super(cause);
	}

...
//		}
	 ...
	 * @param setting 自動生成設定
	 */
	private static void createSystemSearchConditionItem(SearchConditionSection section, EntityDefinition ed, boolean isLoadDisplayLabel,
			AutoGenerateSetting setting) {
	 ...
	 * @return PropertyItem
	 */
	private static PropertyItem createSystemPropertyItems(String propName, EntityDefinition ed, boolean isLoadDisplayLabel, boolean isReadOnly,
			AutoGenerateSetting setting) {
	 ...
	 * @param setting 自動生成設定
	 */
	private static void createSystemSearchResultColumn(SearchResultSection section, EntityDefinition ed, boolean isLoadDisplayLabel,
			AutoGenerateSetting setting) {
				...
				case SELECT:
					...
					if (ep.getResultTypeSpec() != null
						...
						if (isLoadDisplayLabel) {
							...
							SelectValueDefinitionManager svdm = ManagerLocator.getInstance()

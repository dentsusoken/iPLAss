...
@Jsps({
	...
	@Jsp(path="/jsp/gem/spreadsheet/element/section/editor/SpreadSheetViewFilterNumberPropertyEditor.jsp", key=ViewConst.DESIGN_TYPE_GEM_SPREADSHEETVIEW)
})
public class FloatPropertyEditor extends NumberPropertyEditor {

	/** シリアルバージョンUID */
	private static final long serialVersionUID = 966195592008330174L;

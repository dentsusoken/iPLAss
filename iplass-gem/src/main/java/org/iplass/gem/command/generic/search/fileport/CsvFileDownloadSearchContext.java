...
public class CsvFileDownloadSearchContext extends EntityFileDownloadSearchContext {
	...
	public CsvFileDownloadSearchContext(SearchContextBase context) {
		super(context);
	}
	...
	public ResultStreamWriter createWriter() {
		...
		if (isForUpload()) {
			writer = new CsvFileDownloadUploadableWriter(this);
		} else {
			writer = new CsvFileDownloadSearchViewWriter(this);
		}
		return writer;
	}

...
CREATE UNIQUE INDEX "OBJ_UNIQUE_DATE_INDEX1" ON "OBJ_UNIQUE_DATE" ("TENANT_ID", "OBJ_DEF_ID", "COL_NAME", "VAL") LOCAL;
CREATE INDEX "OBJ_UNIQUE_DATE_INDEX2" ON "OBJ_UNIQUE_DATE" ("TENANT_ID", "OBJ_DEF_ID", "OBJ_ID") LOCAL;

 ...
 *
 */
public class Lesser extends ComparisonPredicate {
	private static final long serialVersionUID = 6823655968071512895L;

	public Lesser() {
	}
	
	public Lesser(String propertyName, Object valueLiteral) {
		super(propertyName, valueLiteral);
	}

	public Lesser(ValueExpression property, ValueExpression value) {

 ...
 *
 */
public class DenseRank extends WindowRankFunction {
	private static final long serialVersionUID = -1734249217958539135L;
	...
	@Override
	public DenseRank partitionBy(Object... partitionField) {
		super.partitionBy(partitionField);
		return this;
	}

	@Override
	public DenseRank orderBy(WindowSortSpec... sortSpec) {

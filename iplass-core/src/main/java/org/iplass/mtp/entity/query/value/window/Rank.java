 ...
 *
 */
public class Rank extends WindowRankFunction {
	private static final long serialVersionUID = 4749177890275250481L;
	...
	@Override
	public Rank partitionBy(Object... partitionField) {
		super.partitionBy(partitionField);
		return this;
	}

	@Override
	public Rank orderBy(WindowSortSpec... sortSpec) {

...
public class ConnectionWrapper implements Connection {
	...
	ConnectionWrapper(Connection wrapped, int warnLogThreshold) {
	...
	public Statement createStatement() throws SQLException {
		return new StatementWrapper(wrapped.createStatement(), this, warnLogThreshold);
	}

	public Statement createStatement(int resultSetType,
			int resultSetConcurrency, int resultSetHoldability) throws SQLException {
		return new StatementWrapper(wrapped.createStatement(resultSetType, resultSetConcurrency, resultSetHoldability), this, warnLogThreshold);
	}

	public Statement createStatement(int resultSetType, int resultSetConcurrency) throws SQLException {
		return new StatementWrapper(wrapped.createStatement(resultSetType, resultSetConcurrency), this, warnLogThreshold);
	}
	...
	public PreparedStatement prepareStatement(String sql, int resultSetType,
		...
		return new PreparedStatementWrapper(wrapped.prepareStatement(sql, resultSetType,
				resultSetConcurrency, resultSetHoldability), this, sql, warnLogThreshold);
	}

	public PreparedStatement prepareStatement(String sql, int resultSetType,
			int resultSetConcurrency) throws SQLException {
		return new PreparedStatementWrapper(wrapped.prepareStatement(sql, resultSetType,
				resultSetConcurrency), this, sql, warnLogThreshold);
	}

	public PreparedStatement prepareStatement(String sql, int autoGeneratedKeys)
			throws SQLException {
		return new PreparedStatementWrapper(wrapped.prepareStatement(sql, autoGeneratedKeys), this, sql, warnLogThreshold);
	}

	public PreparedStatement prepareStatement(String sql, int[] columnIndexes)
			throws SQLException {
		return new PreparedStatementWrapper(wrapped.prepareStatement(sql, columnIndexes), this, sql, warnLogThreshold);
	}

	public PreparedStatement prepareStatement(String sql, String[] columnNames)
			throws SQLException {
		return new PreparedStatementWrapper(wrapped.prepareStatement(sql, columnNames), this, sql, warnLogThreshold);
	}

	public PreparedStatement prepareStatement(String sql) throws SQLException {
		return new PreparedStatementWrapper(wrapped.prepareStatement(sql), this, sql, warnLogThreshold);
	}

...
public class EntitySearchCsvWriter implements AutoCloseable {
	...
	public EntitySearchCsvWriter(OutputStream out, String definitionName) {
		this(out, definitionName, new EntityCsvWriteOption(), null);
	}

	public EntitySearchCsvWriter(OutputStream out, String definitionName, EntityCsvWriteOption option) {
		this(out, definitionName, option, null);
	}

	public EntitySearchCsvWriter(OutputStream out, String definitionName, EntityCsvWriteOption option, ZipOutputStream binaryStore) {
		this.out = out;

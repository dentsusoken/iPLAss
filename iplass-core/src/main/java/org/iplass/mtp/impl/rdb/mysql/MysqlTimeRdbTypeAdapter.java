...
/**
 * PreparedStatementのsetTimeでTimestamp型カラムに保存するためのAdapter。
 * 
 * @author K.Higuchi
 *
 */
public class MysqlTimeRdbTypeAdapter extends BaseRdbTypeAdapter.Time {

	public MysqlTimeRdbTypeAdapter(PropertyType propertyType) {
		super(propertyType);
	}

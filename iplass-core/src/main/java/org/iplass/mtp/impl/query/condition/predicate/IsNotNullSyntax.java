...
public class IsNotNullSyntax implements Syntax<IsNotNull>, QueryConstants {

	public void init(SyntaxContext context) {
	}

	public IsNotNull parse(ParseContext str) throws ParseException {
		if (!str.equalsNextToken(IS, ParseContext.TOKEN_DELIMITERS)) {
			throw new ParseException(new EvalError("is not null expected.", this, str));
		}

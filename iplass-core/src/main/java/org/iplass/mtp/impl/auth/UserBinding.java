...
public class UserBinding {
	...
	UserBinding(UserContext userContext, TenantAuthorizeContext authContext) {
		...
		TenantContext callerTenant = ExecuteContext.getCurrentContext()
				.getTenantContext();
		this.otherTenant = callerTenant.getTenantId() != authContext.getTenantContext()
				.getTenantId();
	...
	public boolean isGrantAllPermissions() {
		...
		return userContext.getUser()
				.isAdmin() && authContext.isGrantAllPermissionsToAdmin();
	}

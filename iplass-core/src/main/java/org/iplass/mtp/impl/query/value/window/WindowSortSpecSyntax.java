...
public class WindowSortSpecSyntax implements Syntax<WindowSortSpec>, QueryConstants {
	
	private PolynomialSyntax polynomial;

	public WindowSortSpec parse(ParseContext str) throws ParseException {
		
		//ValueExpression
		ValueExpression ve = polynomial.parse(str);
		WindowSortSpec sortSpec = new WindowSortSpec();

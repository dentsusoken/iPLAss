...
public class HttpClientConfig implements ServiceInitListener<Service> {
	...
	public static final Long DEFAULT_CONNECTION_TIMEOUT = Long.valueOf(30_000L);
	/** ソケットタイムアウト ミリ秒 デフォルト値 */
	public static final Long DEFAULT_SO_TIMEOUT = Long.valueOf(30_000L);
	...
	/** ソケットタイムアウト ミリ秒 */
	private Long soTimeout = DEFAULT_SO_TIMEOUT;
	/** プロキシホスト */
	...
	private Long poolingTimeToLive;
	 ...
	 */
	public Long getPoolingTimeToLive() {
	 ...
	 */
	public void setPoolingTimeToLive(Long poolingTimeToLive) {

...
public class ReferenceBulkDeleteSql {
	...
	public static void addValueForDeleteByOidVersion(BulkDeleteContext bdc, int tenantId, EntityHandler eh, String oid, Long version)
			throws SQLException {
		if (version == null) {
			version = LONG_ZERO;
		}
	...
	public static void addValueForDeleteByOidVersionRefId(BulkDeleteContext bdc, int tenantId, EntityHandler eh, String refDefId, String oid,

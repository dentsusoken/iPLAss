...
public class MysqlTruncateFunctionAdapter extends RoundTruncFunctionAdapter {
	private static final String SQL_FUNCTION_NAME = "TRUNCATE";

	public MysqlTruncateFunctionAdapter(String field) {

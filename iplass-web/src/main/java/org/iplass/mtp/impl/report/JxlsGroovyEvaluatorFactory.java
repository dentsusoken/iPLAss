...
/**
 * JxlsGroovyEvaluator 生成機能
 *
 * @author SEKIGUCHI Naoya
 */
public class JxlsGroovyEvaluatorFactory implements ExpressionEvaluatorFactory {
	 ...
	 */
	public JxlsGroovyEvaluatorFactory(JxlsCompiledScriptCacheStore cacheStore) {
		this.cacheStore = cacheStore;
	}

	@Override
	public ExpressionEvaluator createExpressionEvaluator(String expression) {
		return new JxlsGroovyEvaluator(expression, cacheStore);
	}

...
public class JeeContainerManagedAccountHandle implements AccountHandle {
	private static final long serialVersionUID = -7448145506103956500L;
	...
	public JeeContainerManagedAccountHandle() {
	}

	public JeeContainerManagedAccountHandle(String id) {
		this.id = id;
		this.uniqueKey = id;
	...
	public Credential getCredential() {
		return new JeeContainerManagedCredential(id);
	}

...
gradleでの定義例：
 ...
 implementation 'org.iplass:iplass-gem:3.2.12'
...
https://groupcareers.isid.co.jp/pgisid/u/job.phtml?job_code=781&company_code=1[ISIDグループ キャリア採用ページ 製品・プラットフォーム開発エンジニア]

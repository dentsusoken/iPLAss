...
public class RestrictionRequestAttributePane extends VLayout {
	...
	public RestrictionRequestAttributePane() {
		...
		txaAllowRequestContentTypes.setTooltip(SmartGWTUtil
				.getHoverString(AdminClientMessageUtil.getString("ui_metadata_action_RestrictionRequestAttributePane_allowRequestContentTypes")));
		...
		txtMaxRequestBodySize.setTooltip(
				SmartGWTUtil.getHoverString(AdminClientMessageUtil.getString("ui_metadata_action_RestrictionRequestAttributePane_maxRequestBodySize")));
		...
		txtMaxFileSize.setTooltip(
				SmartGWTUtil.getHoverString(AdminClientMessageUtil.getString("ui_metadata_action_RestrictionRequestAttributePane_maxFileSize")));

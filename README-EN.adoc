...
example when using gradle：
 ...
 compile 'org.iplass:iplass-gem:3.0.25'
...
### master
The master branch contains the source code of the development version, which is regarded as version 3.1.x. (not released yet)

NOTE: It is (Java8 | Java11) / JakartaEE8(JavaEE8) based.

### 3.0.x
3.0.x branch contains the source code of the latest stable version.

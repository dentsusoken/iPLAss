...
The English version for above links are under construction. 
...
The English version for above link is under construction. 
...
NOTE: jar is published at Maven Central and JCenter with groupId : org.iplass.

example when using gradle：

 compile 'org.iplass:iplass-gem:3.0.10'

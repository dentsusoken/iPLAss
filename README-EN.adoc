...
example when using gradle：
 ...
 implementation 'org.iplass:iplass-gem:3.1.22'
...
### master
The master branch contains the source code of the development version, which is regarded as version 3.2.x.

NOTE: It is (Java8 | Java11 | Java17) / JakartaEE8(JavaEE8) based.

### 3.1.x
3.1.x branch contains the source code of the current stable version.

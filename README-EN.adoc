...
example when using gradle：
 ...
 implementation 'org.iplass:iplass-gem:4.1.0'
...
* https://github.com/dentsusoken/iplass-sample-app-km
* https://github.com/dentsusoken/iplass-sample-claude
...
### master
The master branch contains the source code of the latest stable version, which is regarded as version 4.1.x.

NOTE: It is Java21 / JakartaEE10 based.

### 4.0.x
4.0.x branch contains the source code of the previous stable version.

NOTE: It is Java21 / JakartaEE10 based.

### 3.2.x
3.2.x branch contains the source code of the old stable version.

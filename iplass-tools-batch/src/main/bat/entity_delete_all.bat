...
REM APP class
set EXEC_APP=org.iplass.mtp.tools.batch.entity.EntityDeleteAll

REM App Arguments
set APP_ARGS=%EXEC_MODE% %TENANT_ID% %ENTITY_NAME% %WHERE_CLAUSE% %NOTIFY_LISTENERS% %COMMIT_LIMIT%

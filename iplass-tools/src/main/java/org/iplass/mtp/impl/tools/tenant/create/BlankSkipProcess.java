...
public class BlankSkipProcess implements TenantCreateProcess {

	@Override
	public boolean execute(TenantCreateParameter param, LogHandler logHandler) {

		if (param.isCreateBlankTenant()) {
			logHandler.info(ToolsResourceBundleUtil.resourceString(param.getLoggerLanguage(), "tenant.create.completedCreateBlankMsg"));
			return false;
		}
		return true;
	}

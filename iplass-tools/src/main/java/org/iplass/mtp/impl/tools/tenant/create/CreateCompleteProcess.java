...
public class CreateCompleteProcess implements TenantCreateProcess {

	@Override
	public boolean execute(TenantCreateParameter param, LogHandler logHandler) {

		logHandler.info(ToolsResourceBundleUtil.resourceString(param.getLoggerLanguage(), "tenant.create.completedCreateTenantMsg"));

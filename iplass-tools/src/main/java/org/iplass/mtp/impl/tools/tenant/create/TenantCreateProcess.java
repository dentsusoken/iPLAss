...
public interface TenantCreateProcess extends ServiceInitListener<TenantToolService> {

	public boolean execute(TenantCreateParameter param, LogHandler logHandler);

	@Override
	default public void inited(TenantToolService service, Config config) {
	}

	@Override
	default public void destroyed() {
	}

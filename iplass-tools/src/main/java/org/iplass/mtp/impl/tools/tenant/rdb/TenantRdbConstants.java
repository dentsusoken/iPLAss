...
public interface TenantRdbConstants {
	...
	public static final Set<String> EXCLUDE_SUB_PARTITION_TABLE = Stream.of(
			"obj_blob", "lob_store", "obj_blob_rb", "counter", "task_queue_hi")
			.collect(Collectors.toSet());
	...
	public static final Set<String> CHECK_EXIST_TABLE = Stream.of(
			"crawl_log", "delete_log", "task_queue", "task_queue_hi", "obj_data", "obj_data_rb")
			.collect(Collectors.toSet());
	...
	public static final Set<String> STORAGE_SPACE_TABLE = Stream.of(
			"obj_store", "obj_store_rb"

			, "obj_ref", "obj_ref_rb"

			, "obj_index_date", "obj_index_dbl", "obj_index_num", "obj_index_str", "obj_index_ts"

			, "obj_unique_date", "obj_unique_dbl", "obj_unique_num", "obj_unique_str", "obj_unique_ts")
			.collect(Collectors.toSet());
